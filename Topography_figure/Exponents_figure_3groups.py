...
datafile1 = 'D:\\Project\\paper4\\统计\\06Topography\\results\\' + d + '.mat'
# 读取mat文件
...
datafile2 = 'D:\\Project\\paper4\\统计\\06Topography\\results\\' + e + '.mat'
# 读取mat文件
...
datafile3 = 'D:\\Project\\paper4\\统计\\06Topography\\results\\' + f + '.mat'
# 读取mat文件
...
ax[1].set_xlabel('\n'+'HC vs PD_ON')
ax[2].set_xlabel('\n'+'PD_OFF vs PD_ON')
ax[1].set_title('Comparisons of Exponents'+'\n')

#plt.xlabel('Comparison in Exponents', horizontalalignment='left', x=0.5)
