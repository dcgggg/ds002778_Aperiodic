...
datafile1='D:\\Project\\paper4\\统计\\06Topography\\results\\hc_exponents.mat'
hc_exponents = scipy.io.loadmat(datafile1)
hc_exponents = hc_exponents .get('hc_exponents')
#创建info对象
info = mne.create_info(ch_names=biosemi_montage.ch_names, sfreq=250.,ch_types='eeg')
#创建evokeds对象 1                      
evoked1= mne.EvokedArray(hc_exponents, info)
#evokeds设置通道1
evoked1.set_montage(biosemi_montage)
print(evoked1.data)


datafile12='D:\\Project\\paper4\\统计\\06Topography\\results\\pdoff_exponents.mat'
pdoff_exponents = scipy.io.loadmat(datafile12)
pdoff_exponents = pdoff_exponents .get('pdoff_exponents')
#创建info对象
info = mne.create_info(ch_names=biosemi_montage.ch_names, sfreq=250.,ch_types='eeg')
#创建evokeds对象 2
evoked2= mne.EvokedArray(pdoff_exponents, info)
#evokeds设置通道2
evoked2.set_montage(biosemi_montage)
print(evoked2.data)


datafile13='D:\\Project\\paper4\\统计\\06Topography\\results\\pdon_exponents.mat'
pdon_exponents = scipy.io.loadmat(datafile13)
pdon_exponents = pdon_exponents .get('pdon_exponents')
#创建info对象
info = mne.create_info(ch_names=biosemi_montage.ch_names, sfreq=250.,ch_types='eeg')
#创建evokeds对象 3
evoked3= mne.EvokedArray(pdon_exponents, info)
#evokeds设置通道3
...
plt.colorbar(im, ax=[ax[0], ax[1],ax[2]], fraction=0.02, label="Exponents")
